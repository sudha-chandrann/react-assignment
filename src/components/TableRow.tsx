    ...
    <div className="bg-white h-12 flex items-center">
      ...
      <div className="grid grid-cols-11 flex-1 h-12">
        ...
        <EditableCell
          ...
          contentClassName="text-sm sm:text-lg text-gray-600 truncate max-w-[300px]"
        >
            {row.jobRequest}
        </EditableCell>
        ...
        <EditableCell
          ...
          onCellBlur={onCellBlur}
          textAlign="right"
          contentClassName="text-sm sm:text-lg text-gray-600 truncate max-w-[150px]"
        >
          <span>
            {row.dateSubmitted}
          </span>
        ...
        <EditableCell
          ...
          isStatus={true}
          textAlign="center"
          contentClassName={`font-semibold text-sm truncate rounded-full ${row.status && getStatusColor(row.status)} px-3 py-1`}
        >
            {row.status}
        </EditableCell>
        ...
        <EditableCell
          ...
          isPriority={true}
          textAlign="center"
          contentClassName={`text-sm sm:text-lg ${row.priority && getPriorityColor(row.priority)} px-2 py-1`}
        >
            {row.priority}
        </EditableCell>
